    ...
    public class ProcessManagementGUI extends JFrame {
        ...
        private void configureUserPermissions() {
            ...
            createProcessButton.setVisible(isAdmin);
            deleteProcessButton.setVisible(isAdmin);

            // También deshabilitar los botones (buena práctica de seguridad)
            createProcessButton.setEnabled(isAdmin);
            deleteProcessButton.setEnabled(isAdmin);
        ...
        private void createProcessPanel() {
            ...
            createProcessButton = createStyledButton("Crear Proceso");
            deleteProcessButton = createStyledButton("Eliminar Proceso");
        ...
        public static void main(String[] args) {
            ...
            SwingUtilities.invokeLater(() -> {
                // Create a dialog to select user type
                String[] options = {"Administrador", "Usuario Regular"};
                ...
                String userType = (choice == 0) ? "admin" : "user";

                // Create GUI with selected user type
